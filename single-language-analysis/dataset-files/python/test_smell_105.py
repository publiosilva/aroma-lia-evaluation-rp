# Original URL: https://github.com/bofm/python-caching/blob/16de50c119f8896e923e3f10488ecf6ffe535f45/tests/test_cache.py#L275-L298

@pytest.mark.parametrize('storage', ['file', 'memory'])
def test_smell_105(tmpdir, storage):
