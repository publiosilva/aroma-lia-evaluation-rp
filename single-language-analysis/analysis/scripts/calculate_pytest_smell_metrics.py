...
GROUND_TRUTH_FILE = os.path.join(
    CURRENT_DIR, "..", "..", "dataset-sheets", "ground-truth", "python.csv")
TOOL_RESULT_FILE = os.path.join(CURRENT_DIR, "..", "..", "tool-execution",
                                "pytest-smell", "summary", "pytest-smell-detections.csv")

OUTPUT_OVERALL_METRICS = os.path.join(
    CURRENT_DIR, "..", "results", "pytest-smell-overall-metrics.csv")
OUTPUT_PER_SMELL_METRICS = os.path.join(
    CURRENT_DIR, "..", "results", "pytest-smell-per-smell-metrics.csv")
